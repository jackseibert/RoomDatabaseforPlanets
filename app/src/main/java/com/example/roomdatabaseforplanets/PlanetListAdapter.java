...
public class PlanetListAdapter extends RecyclerView.Adapter<PlanetListAdapter.PlanetViewHolder> {
    class PlanetViewHolder extends RecyclerView.ViewHolder {
        ...
        private PlanetViewHolder(View itemView) {
            super(itemView);
            planetItemView = itemView.findViewById(R.id.textViewPlanetName);
        }
    }

    private final LayoutInflater mInflater;
    private List<Planet> mPlanets; // Cached copy of planets
    ...
    // mPlanets has not been updated (means initially, it's null, and we can't return null).
    @Override
